 ...
 * IMPORTANT: @ file references must be INSIDE the quoted prompt
 */
function buildGeminiCommand(prompt, files = [], additionalContext = "") {
  // Build the full prompt with @ references inside
  ...
  // Add file references with @ syntax INSIDE the prompt
